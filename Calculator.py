print("Welcome to Khushi's Calculator, May you have a good experience.")
i=0
choice_YN="Y"
while(i==0 and choice_YN=="Y"):
    print("""Menu:
The List of Task which my Calculator can do are:
    ...
    choice_YN=input("""Do you want to continue?
Press Y to Continue and N to Close the Calculator.""")
    


    choice_YN=choice_YN.upper()
if(choice_YN=="N"):
    print("Thank You!! ")
